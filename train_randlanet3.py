...
from model.randlanet_mod import RandLANet
...
if __name__ == '__main__':
    ...
    if CL:
        pretrain = "step0_c2f_Geometric-C2f_" #"step0_c2f_Overlapped" #"step1_SM_Overlapped" #"step0_c2f_Overlapped"
        #pretrain = "step"+str(step-1) #"step0__18-54-36" #pcs_semantic-kitti_randlanet_bis"  # "s3dis"
        logdir = "log/train" + "_step" + str(lstep) + "_OLD-CE_" + setup + "_" + datetime.datetime.now().strftime("%H-%M-%S") + pretrain
    else:
    ...
    for e in range(epochs):
        ...
        for i, data in enumerate(pbar):
            ...
            l = loss(o.swapaxes(1, 2), y) # + 0.5 * old_ce # if step < tot_steps//2 else loss2(o, y)
            l.backward()
